...
Job.create(name: 'Java senior backend developper', expectations: 'JAVA 8, Junit 4, Thymleaf', description: 'Create the new Facebook', entreprise_id: 5, adresse_id: 1, experience_id: 4)
...
#Job.create(name: 'PHP senior developper', expectations: 'Laravel, Senior', description: 'Netflix but better', entreprise_id: 4,  adresse_id: 2, experience_id: 6)
#Job.create(name: 'Angular medior developper', expectations: 'Using Angular for 4 years minimum', description: 'Netflix but better', entreprise_id: 4,  adresse_id: 2, experience_id: 2)
